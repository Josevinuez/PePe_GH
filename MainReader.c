...
pp_void startReader(String, String, pp_char, i32, i32);
...
************************************************************
*/
pp_void startReader(String program, String input, pp_char mode, i32 size, i32 increment) {

	ReaderPointer bufferp;		/* pointer to Buffer structure */
	FILE* fileHandler;			/* input file handle */
	i32 loadSize = 0;		/* the size of the file loaded in the buffer */
	pp_char symbol;			/* symbol read from input file */
